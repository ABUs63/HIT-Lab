...
HD_PWD='C:/Users/LANGLANG/Desktop/car_light/car_light.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log car_light.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source car_light.tcl
