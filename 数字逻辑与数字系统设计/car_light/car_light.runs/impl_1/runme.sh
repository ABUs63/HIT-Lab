...
HD_PWD='C:/Users/LANGLANG/Desktop/car_light/car_light.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log car_light.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source car_light.tcl -notrace
