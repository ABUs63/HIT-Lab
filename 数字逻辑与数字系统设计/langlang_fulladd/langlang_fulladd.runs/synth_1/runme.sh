...
HD_PWD='C:/Users/LANGLANG/Desktop/vivado/langlang_fulladd/langlang_fulladd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fulladd.tcl
