...
HD_PWD='C:/Users/LANGLANG/Desktop/vivado/langlang_jktrigger/langlang_jktrigger.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jk_trigger.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source jk_trigger.tcl
