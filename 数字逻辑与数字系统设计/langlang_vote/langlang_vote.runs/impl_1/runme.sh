...
HD_PWD='C:/Users/LANGLANG/Desktop/vivado/langlang_vote/langlang_vote.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vote.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vote.tcl -notrace
