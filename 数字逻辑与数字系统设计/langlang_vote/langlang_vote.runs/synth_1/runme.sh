...
HD_PWD='C:/Users/LANGLANG/Desktop/vivado/langlang_vote/langlang_vote.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vote.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vote.tcl
