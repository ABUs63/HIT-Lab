...
HD_PWD='C:/Users/LANGLANG/Desktop/vivado/four_beat/four_beat.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_beat.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_beat.tcl
