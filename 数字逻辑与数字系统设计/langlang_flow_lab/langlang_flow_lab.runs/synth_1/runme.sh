...
HD_PWD='C:/Users/LANGLANG/Desktop/vivado/langlang_flow_lab/langlang_flow_lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flow_lab.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flow_lab.tcl
