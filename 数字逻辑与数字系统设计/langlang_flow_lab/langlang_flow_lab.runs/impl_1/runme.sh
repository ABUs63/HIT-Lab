...
HD_PWD='C:/Users/LANGLANG/Desktop/vivado/langlang_flow_lab/langlang_flow_lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flow_lab.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flow_lab.tcl -notrace
